...
namespace DiscordIntegration
{
    ...
    public class DiscordIntegration : Plugin<Config>
    {
        ...
        public override void OnEnabled()
        {
            ...
            Network = new Network(Config.IPAddress, Config.Port, TimeSpan.FromSeconds(Config.Bot.ReconnectionInterval));
        ...
        private void RegisterEvents()
        {
            ...
            Handlers.Player.ActivatingGenerator += playerHandler.OnActivatingGenerator;
            Handlers.Player.StoppingGenerator += playerHandler.OnStoppingGenerator;
            ...
            Handlers.Player.ThrownProjectile += playerHandler.OnThrownProjectile;
            Handlers.Player.Hurting += playerHandler.OnHurting;
            Handlers.Player.Dying += playerHandler.OnDying;
            Handlers.Player.Banning += playerHandler.OnBanning;
